/**
 * SADA Faculty Scraper
 *
 * - Scrapes faculty names from SADA NUST website
	...
	async fetch(request, env, ctx) {
		try {
			...
			const headers = {
				...
				'Referer': 'https://sada.nust.edu.pk/',
				'DNT': '1',
			...
			const response = await fetch('https://sada.nust.edu.pk/faculty/', {
				headers,
				cf: {
					cacheTtl: 0,
