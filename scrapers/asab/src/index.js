/**
 * ASAB Faculty Scraper
 *
 * - Scrapes faculty names from ASAB NUST website
	...
	async fetch(request, env, ctx) {
		try {
			...
			const headers = {
				...
				'Referer': 'https://asab.nust.edu.pk/',
				'DNT': '1',
			...
			const response = await fetch('https://asab.nust.edu.pk/faculty/', {
				headers,
				cf: {
					cacheTtl: 0,
